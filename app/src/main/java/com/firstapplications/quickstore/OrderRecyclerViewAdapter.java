...
public class OrderRecyclerViewAdapter extends RecyclerView.Adapter<OrderViewHolder>
{
    ...
    public OrderRecyclerViewAdapter(List<ProductOrdered> productOrdereds)
    {
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).
                inflate(R.layout.qstr_order_item, parent, false);
    ...
    {
        holder.setProduct(productOrdereds.get(position).getProductName());
    }
